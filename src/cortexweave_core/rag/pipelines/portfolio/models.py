...
class _AllocationMixin:
    ...
    xirr_percent = Column(Numeric(10, 4))
    prescribed_allocation_percent = Column(Numeric(10, 4))
    current_allocation_percent = Column(Numeric(10, 4))
    deviation_percent = Column(Numeric(10, 4))
...
class PortfolioMutualFundHolding(RAGReadBase):
    ...
    percent_to_mf_portfolio = Column(Numeric(10, 4))
    purchase_price = Column(Numeric(18, 4))
    nav = Column(Numeric(18, 4))
    gain_loss_percent = Column(Numeric(10, 4))
    holding_period_months = Column(Integer)
    realized_gain_loss = Column(Numeric(18, 2))
...
class PortfolioPMSHolding(RAGReadBase):
    ...
    unrealized_gain_loss = Column(Numeric(18, 2))
    unrealized_gain_loss_percent = Column(Numeric(10, 4))
    percent_to_pms_portfolio = Column(Numeric(10, 4))
    holding_period_months = Column(Integer)
    source_page = Column(Integer)
    raw_text = Column(Text)
...
class PortfolioBondHolding(RAGReadBase):
    ...
    unrealized_gain_loss = Column(Numeric(18, 2))
    unrealized_gain_loss_percent = Column(Numeric(10, 4))
    percent_to_bond_portfolio = Column(Numeric(10, 4))
    holding_period_months = Column(Integer)
    realized_gain_loss = Column(Numeric(18, 2))
    source_page = Column(Integer)
    raw_text = Column(Text)
